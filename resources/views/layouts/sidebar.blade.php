    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html"><span class="brand-logo">
                    ...
                    <h2 class="brand-text">HA Logistics</h2>
                </a></li>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Invoice">Menu</span></a>
                <ul class="menu-content">
                    ...
                    <li><a class="d-flex align-items-center" href="/CreateInventory"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Create Inventory</span></a>
                    </li>
                    </li>
                    <li><a class="d-flex align-items-center" href="/trash"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Trash</span></a>
                    </li>
                </ul>
            </li>
        </ul>
